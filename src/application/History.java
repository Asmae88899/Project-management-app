...
public class History implements Initializable{
	...
	private void show(){
		table.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
			    ...
			    Global2.student11=parts[0];
			    Global2.student22= parts[1];
			    ...
			    try {
			    	 ...
			    	 preparedStatement.setString(1, Global2.student11);
			    ...
			    for (Etudiant liste:data4 )
			    {
			    	...
			    	list4.add(Integer.toString(liste.getIdgroup()));
			                 ...
			                 Global2.idgroup1=Integer.parseInt(list4.get(0));
	...
	public void add(ActionEvent e) throws IOException{
		...
		Parent root=FXMLLoader.load(getClass().getResource("TableHistory.fxml"));
