...
public class GroupPanel2 implements Initializable{
	...
	private void show(){
		table.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
			    ...
			    Global2.group=list.get(0);
			    
			    Global2.nom1=parts[0];
			    ...
			    try {
			    	 ...
			    	 preparedStatement.setString(1, Global2.nom1);
			    ...
			    for (Etudiant liste:data4 )
			    {
			    	...
			    	list4.add(Integer.toString(liste.getIdgroup()));
			                 ...
			                 Global2.idgroup=Integer.parseInt(list4.get(0));
...
*/
	...
	public void Push(ActionEvent e) throws IOException
	{
